    ...
    <div className='w-full h-screen  top-0 left-0   flex flex-col items-center text-center  '>
      <Map />
       ...
       <div className='flex flex-col items-center text-center relative mt-[140px] '>
        ...
        <button className=' hover:scale-105 duration-300 ease-in-out  rounded-[4px text-background text-lg font-bold leading-normal shadow-buttonShadow py-[16px] px-[54px] cursor-pointer bg-tertinary '>Explore Plans</button>
